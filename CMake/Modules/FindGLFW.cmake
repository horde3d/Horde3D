...
IF(NOT GLFW_LIBRARY OR HORDE3D_FORCE_LOCAL_GLFW)
    ...
    ExternalProject_Add(project_glfw 
        ...
        CMAKE_ARGS -DCMAKE_INSTALL_PREFIX:PATH=<INSTALL_DIR> -DCMAKE_CONFIGURATION_TYPES:STRING=${CMAKE_CFG_INTDIR} -DGLFW_BUILD_EXAMPLES:BOOL=NO
        LOG_DOWNLOAD 1
        LOG_UPDATE 1
        LOG_CONFIGURE 1
        LOG_BUILD 1
...
ENDIF(NOT GLFW_LIBRARY OR HORDE3D_FORCE_LOCAL_GLFW)
