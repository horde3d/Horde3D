...
**NOTE:** to build samples you also need to have [GLFW](http://www.glfw.org/download.html) *(>3.x)* installed. If not, a default version will be automatically built and linked for you.
