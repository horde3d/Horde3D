...
IF(NOT GLFW_LIBRARY_PATH OR HORDE3D_FORCE_DOWNLOAD_GLFW)
  ...
  ExternalProject_Add(project_glfw
        ...
        CMAKE_ARGS -DCMAKE_TOOLCHAIN_FILE=${CMAKE_TOOLCHAIN_FILE} -DCMAKE_INSTALL_PREFIX:PATH=<INSTALL_DIR> -DCMAKE_INSTALL_LIBDIR:PATH=lib -DCMAKE_BUILD_TYPE=Release -DGLFW_BUILD_DOCS:BOOL=OFF -DGLFW_BUILD_EXAMPLES:BOOL=OFF -DGLFW_BUILD_TESTS:BOOL=OFF
        LOG_DOWNLOAD 1
        LOG_UPDATE 1
        LOG_CONFIGURE 1
        LOG_BUILD 1
...
else(NOT GLFW_LIBRARY_PATH OR HORDE3D_FORCE_DOWNLOAD_GLFW)
  add_library(GLFW_LIBRARY UNKNOWN IMPORTED)
  set_property(TARGET GLFW_LIBRARY PROPERTY IMPORTED_LOCATION  ${GLFW_LIBRARY_PATH} )
...
IF(GLFW_LIBRARY_PATH)
  ...
  IF(UNIX AND NOT APPLE)
    ...
    if (RT_LIBRARY AND NOT ${CMAKE_SYSTEM_PROCESSOR} STREQUAL "AARCH64")
  ...
  # For Unix, GLFW should be linked to X11-related libraries or Wayland libraries.
